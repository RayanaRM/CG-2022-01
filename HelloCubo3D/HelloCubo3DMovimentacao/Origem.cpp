...
int setupGeometry()
{
	GLfloat vertices[] = {
				...
				0.5f, 0.5f,-0.5f, 1.0, 0.0, 0.0, //superficie vermelha inicio
		...
		-0.5f,-0.5f,-0.5f, 0.0, 1.0, 0.0, //superficie verde inicio
		...
		0.5f,-0.5f, 0.5f, 0.0, 0.0, 1.0, //superficie azul inicio
		...
		-0.5f, 0.5f, 0.5f, 1.0, 1.0, 0.0,//superfície amarela inicio
		...
		0.5f,-0.5f,-0.5f, 0.0, 1.0, 1.0, // superfície azul claro inicio
		...
		0.5f, 0.5f, 0.5f, 1.0, 0.0, 1.0, // superfície lilás inicio
		...
		0.8f,-0.5f, 0.8f, 0.0, 0.5, 0.5, //chão
		-0.8f,-0.5f, 0.8f, 0.0, 0.5, 0.5,
		-0.8f,-0.5f,-0.8f, 0.0, 0.5, 0.5,
